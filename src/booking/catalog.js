...
export const AIRPORTS = [
  ...
  { id: 'BOM', name: 'Chhatrapati Shivaji Maharaj International Airport', city: 'Mumbai' },
  ...
  { id: 'CCU', name: 'Netaji Subhas Chandra Bose International Airport', city: 'Kolkata' },
  { id: 'ATQ', name: 'Sri Guru Ram Dass Jee International Airport', city: 'Amritsar' },
  { id: 'AMD', name: 'Sardar Vallabhbhai Patel International Airport', city: 'Ahmedabad' },
